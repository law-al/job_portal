  ...
  const onSubmit = async (data: LoginSchemaType) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        const errorMessage = result.error === 'CredentialsSignin' ? 'Invalid email or password. Please try again.' : result.error;
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-gray-700 to-gray-900 relative">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&h=1000&fit=crop')",
          }}
        ></div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="mb-32">
            ...
            <p className="text-xl text-gray-300">Connecting talented professionals with innovative companies.</p>
          </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          ...
          <div className="mb-8">
            ...
            {loginErrors && <p className="mt-10 text-center text-red-500 italic">{loginErrors}</p>}
          </div>
